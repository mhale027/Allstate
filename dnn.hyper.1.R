...
dnn.1 <- h2o.deeplearning(x=features,
                          y=response,
...
dnn.2 <- h2o.deeplearning(x=features,
                          y=response,
                          training_frame = train.hex,
                          validation_frame = valid.hex,
...
dnn.grid.1 <- h2o.getGrid("dnn.grid")



dnn.3 <- h2o.deeplearning(x=features,
                          y=response,
                          training_frame = train.hex,
                          validation_frame = valid.hex,
                          overwrite_with_best_model = FALSE,
